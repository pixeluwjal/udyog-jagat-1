...
export default function ResetPasswordPage() {
    ...
    useEffect(() => {
        ...
        if (tokenFromUrl) {
            ...
            // Optionally, you could make an API call here to pre-validate the token
            // before the user even submits the form, but it's not strictly necessary
            // as the backend will do the full validation on submission.
            // For now, we'll assume the presence of a token means we should show the form.
    ...
    if (isTokenValid === null) {
        // Still checking for token in URL
        return (
